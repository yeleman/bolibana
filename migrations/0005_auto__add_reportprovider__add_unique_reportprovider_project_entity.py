...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ReportProvider'
        db.create_table('bolibana_reportprovider', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bolibana.Project'])),
        ...
        db.send_create_signal('bolibana', ['ReportProvider'])

        # Adding unique constraint on 'ReportProvider', fields ['project', 'entity']
        db.create_unique('bolibana_reportprovider', ['project_id', 'entity_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ReportProvider', fields ['project', 'entity']
        db.delete_unique('bolibana_reportprovider', ['project_id', 'entity_id'])

        # Deleting model 'ReportProvider'
        db.delete_table('bolibana_reportprovider')
    ...
    models = {
        ...
        'bolibana.reportprovider': {
            'Meta': {'unique_together': "(('project', 'entity'),)", 'object_name': 'ReportProvider'},
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bolibana.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bolibana.Project']"})
        },
        'bolibana.role': {
